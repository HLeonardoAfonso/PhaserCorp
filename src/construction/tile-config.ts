...
export const ROCK_TILES: number[] = [

  TILES.ROCK_WALL_GRASS_LEFT,
  TILES.ROCK_WALL_GRASS_MID,
  TILES.ROCK_WALL_GRASS_RIGHT,
  TILES.ROCK_WALL_GRASS_SINGLE,
  TILES.ROCK_WALL_WATER_LEFT,
  TILES.ROCK_WALL_WATER_MID,
  TILES.ROCK_WALL_WATER_RIGHT,
  TILES.ROCK_WALL_WATER_SINGLE,
